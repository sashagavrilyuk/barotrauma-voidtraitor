...
language.ObjectiveHudSaboteurSummary = "Вы диверсант. Выводите из строя системы подлодки и выполняйте назначенные диверсии, не раскрывая себя."
...
language.SaboteurYou = "Вы диверсант!\nВыводите из строя системы подлодки, уничтожайте ресурсы и действуйте незаметно."
language.SaboteurOther = "Диверсант %s"
...
language.ObjectiveSabotage = "Выведите из строя: %s"
language.ObjectiveSabotageReactor = "Приведите ядерный реактор к взрыву"
language.ObjectiveFloodSubmarine = "Затопите подводную лодку минимум на %d процентов"
language.ObjectiveDestroyFuelRods = "Уничтожьте топливные стержни в деконструкторе (%d/%d)"
...
language.SaboteurNextTarget = "Диверсия выполнена. Скоро будет назначена новая цель."
language.SaboteurNewObjective = "Новая цель диверсии: %s"
