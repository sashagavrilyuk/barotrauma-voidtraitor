...
language.RoundDistinctionsTitle = "ROUND DISTINCTIONS"
language.RoundDistinctionHealing = "Hands of Salvation — %s — %d health restored"
language.RoundDistinctionSelfHealing = "Own Doctor — %s — %d self-healing"
language.RoundDistinctionHullRepair = "Steel Seam — %s — %d hull damage repaired"
language.RoundDistinctionMechanicalRepair = "Machine Heart — %s — %d mechanical repair"
language.RoundDistinctionElectricalRepair = "Master of Wires — %s — %d electrical repair"
language.RoundDistinctionDamage = "Strike Force — %s — %d damage to enemies"
language.RoundDistinctionTurretDamage = "Eye of Artillery — %s — %d turret damage"
language.RoundDistinctionKills = "Exterminator — %s — %d enemies eliminated"
language.RoundDarkMeritsTitle = "DARK MERITS"
language.RoundDistinctionGreyCardinal = "Grey Cardinal — %s — %d objective points"
language.RoundDistinctionBloodyTrail = "Bloody Trail — %s — %d crew kills"
language.RoundDistinctionCleanWork = "Clean Work — %s — %d objectives, %d direct crew damage"
